...
- **Condicion multiple `swich`**
  javascript dispone de una opcion para crear estructuras condicionales multiples, `swich` permite crear estructura mas optimizada para cubrir un amplio abanico de personalidades
  ````js
